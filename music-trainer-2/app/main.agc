...
#constant BUILD_NUMBER	(22)
#constant BUILD_DATE 	("2 Jan 2017")
...
function PlayOneSong(songFile$ as String)
	...
	DRAWProcessStrings(song) 																		// Update the string display
...
//	next n
	...
	DRAWEraseAll(song)
	CHORDDelete(cdNow,song.strings)
	CHORDDelete(cdNext,song.strings)
