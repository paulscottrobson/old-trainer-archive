...
/// <reference path="./statictabdisplay.ts"/>

class HorizontalDisplayManager extends Phaser.Group implements IManager {
     ...
     * @memberOf HorizontalDisplayManager
     */
    constructor(game:Phaser.Game,music:Music,width:number = null,height:number = null) {
        super(game);
