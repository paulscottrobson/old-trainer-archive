...
class PreloadState extends Phaser.State {
    ...
    public static NOTE_COUNT:number = 42;
    ...
    preload(): void {
        ...
        // Load the ocpix sprite atlases.
        for (var picset of ["4-hole-atlas","6-hole-atlas"]) {
            this.game.load.atlas(picset,
                                 "assets/sprites/"+picset+".png",
                                 "assets/sprites/"+picset+".json");
        }
        // Load the fonts
        ...
        // Load the music file.
        var src:string = OcarinaApplication.getURLName("music","music.json");
