...
window.onload = function () {
    var game = new OcarinaApplication();
};
var OcarinaApplication = (function (_super) {
    __extends(OcarinaApplication, _super);
    function OcarinaApplication() {
    ...
    OcarinaApplication.getURLName = function (key, defaultValue) {
...
var PreloadState = (function (_super) {
    ...
    PreloadState.prototype.preload = function () {
        ...
        for (var _i = 0, _a = ["4-hole-atlas", "6-hole-atlas"]; _i < _a.length; _i++) {
            var picset = _a[_i];
            this.game.load.atlas(picset, "assets/sprites/" + picset + ".png", "assets/sprites/" + picset + ".json");
        }
        for (var _b = 0, _c = ["7seg", "font"]; _b < _c.length; _b++) {
            var fontName = _c[_b];
        ...
        var src = OcarinaApplication.getURLName("music", "music.json");
        this.game.load.json("music", OcarinaApplication.getURLName("music", src));
